function TestingCompilerPass() {
  ...
  return {
    ...
    validateNumericSubExpression: loggerWithName("validateNumericSubExpression"),
    validateStringSubExpression: loggerWithName("validateStringSubExpression"),
    ...
    boolParenExpression: loggerWithName("boolParenExpression"),
