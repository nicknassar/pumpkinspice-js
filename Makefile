...
TEST_SOURCES := run_tests.js.template initialize_tests.js base_tester.js parser_tests.js.template type_manager_tests.js.template testing_compiler_pass.js testing_logger.js parser.js display.js legacy.js global_utilities.js parser.js type_manager.js
